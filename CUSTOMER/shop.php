...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="../../FrontAssets/img///favicon.ico">
    ...
    <link rel="stylesheet" href="../FrontAssets/css/fontawesome.min.css">
    ...
    <link rel="stylesheet" href="../FrontAssets/css/fontawesome-all.min.css">
    <link rel="stylesheet" href="../FrontAssets/css/meanmenu.css">
    <link rel="stylesheet" href="../FrontAssets/css/slick.css">
    <link rel="stylesheet" href="../FrontAssets/css/default.css">
...
<body>
            ...
            <div class="header-nav position-relative">
                <div class="row align-items-center">
                        ...
                        <div class="header-nav">
                            <nav>
                                <ul>
                                    <li><a href="javascript:void(0)" class="active"><span>Home <i class="fal fa-angle-down"></i></span></a>
                                        ...
                                        <ul class="submenu">
                                            <li><a href="index.html">Home
                                                    Fashion 1</a></li>
                                            <li><a href="index2.html">Home
                                                    Fashion 2</a></li>
                                            <li><a href="index3.html">Home
                                                    Fashion 3</a></li>
                                            <li><a href="index4.html">Home
                                                    Fashion 4</a></li>
                                            <li><a href="index5.html">Home
                                                    Fashion 5</a></li>
                                            <li><a href="index6.html">Home
                                                    Fashion 6</a></li>
                                            <li><a href="index7.html">Home
                                                    Fashion 7</a></li>

                                        </ul>
                                    </li>
                                    <li class="position-static"><a href="javascript:void(0)"><span>Shop
                                                <i class="fal fa-angle-down"></i></span></a>
                                        <div class="mega-menu">
                                            <div class="col-xl-7 pl-0 position-static">
                                                <ul>
                                                    <li><a href="shop.html">Shop
                                                            Layout</a></li>
                                                    <li><a href="shop4.html">Masonry
                                                            – Grid</a></li>
                                                    <li><a href="shop3.html">Pagination</a></li>
                                                    <li><a href="shop2.html">Ajax
                                                            Load More</a></li>
                                                    <li><a href="shop2.html">Infinite
                                                            Scroll</a></li>
                                                    <li><a href="shop2.html">Sidebar
                                                            Right</a></li>
                                                    <li><a href="shop.html">Sidebar
                                                            Left</a></li>
                                                </ul>
                                                ...
                                                <ul>
                                                    <li><a href="shop.html">Shop
                                                            Pages</a></li>
                                                    <li><a href="shop2.html">List
                                                            View</a></li>
                                                    <li><a href="shop3.html">Small
                                                            Products</a></li>
                                                    <li><a href="shop2.html">Large
                                                            Products</a></li>
                                                    <li><a href="shop3.html">Shop
                                                            — 3 Items</a></li>
                                                    <li><a href="shop3.html">Shop
                                                            — 4 Items</a></li>
                                                    <li><a href="shop4.html">Shop
                                                            — 5 Items</a></li>
                                                </ul>

                                                <ul>
                                                    <li><a href="single-product-2.html">Product
                                                            Layout</a></li>
                                                    <li><a href="single-product.html">Description
                                                            Sticky</a></li>
                                                    <li><a href="single-product-2.html">Product
                                                            Carousels</a></li>
                                                    <li><a href="single-product-3.html">Gallery
                                                            Modern</a></li>
                                                    <li><a href="single-product-4.html">Thumbnail
                                                            Left</a></li>
                                                    <li><a href="single-product-5.html">Thumbnail
                                                            Right</a></li>
                                                    <li><a href="single-product-6.html">Thumbnail
                                                            Botttom</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
                                    <li><a href="javascript:void(0)"><span>Blog
                                                <i class="fal fa-angle-down"></i></span>
                                        </a>
                                        <ul class="submenu">
                                            <li><a href="blog.html">Grid
                                                    layout</a></li>
                                            <li><a href="blog2.html">Large
                                                    image</a></li>
                                            <li><a href="blog3.html">Left
                                                    Sidebar</a></li>
                                            <li><a href="blog4.html">Right
                                                    Sidebar</a></li>
                                            <li><a href="blog5.html">No
                                                    sidebar</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="javascript:void(0)"><span>Portfolio
                                                <i class="fal fa-angle-down"></i></span>
                                        </a>
                                        <ul class="submenu">
                                    ...
                                    <li><a href="javascript:void(0)"><span>Page</span>
                                            <i class="fal fa-angle-down"></i></a>
                                        <ul class="submenu">
                                            <li><a href="about.html">About</a></li>
                                            <li><a href="question.html">Frequently
                                                    Questions</a></li>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-3">
                        <div class="logo">
                            <a href="index3.html"><img src="FrontAssets/../FrontAssets/img//logo/logo1.png" alt></a>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-3 col-6 col-md-6 col-sm-6 col-9">
                        <div class="header-right">
                            <ul class="text-right">
                                <li><a href="login.html" class="account"><i class="fal fa-user-friends"></i>
                                        <article class="account-registar d-inline-block">Login/Sign
                                            up</article>
                                    </a></li>
                                        ...
                                        <div class="search-popup-inner mt-135">
                                            ...
                                            <div class="search-content pt-55">
                                                <ul class="text-center">
                                                    <li><a href="javascript:void(0)" class="active">All
                                                            categories</a></li>
                                                    <li><a href="javascript:void(0)">Clothing</a></li>
                                                    <li><a href="javascript:void(0)">Gift
                                                            Cards</a></li>
                                                    ...
                                                    <ul class="text-left">
                                                        <li class="d-block d-flex align-items-center">
                                                            <div class="search-result-img">
                                                                <img src="FrontAssets/../FrontAssets/img//product/1.jpg" class="w-100" alt>
                                                            </div>
                                                        ...
                                                        <li class="d-block d-flex align-items-center">
                                                            <div class="search-result-img">
                                                                <img src="FrontAssets/../FrontAssets/img//product/2.jpg" class="w-100" alt>
                                                            </div>
                                                            <div class="search-result-desc pl-10">
                                                                <a href="single-product-4.html" class="title px-0">RIMINI
                                                                    -
                                                                    Folding
                                                                    leather
                                                                    deck
                                                        ...
                                                        <li class="d-block d-flex align-items-center">
                                                            <div class="search-result-img">
                                                                <img src="FrontAssets/../FrontAssets/img//product/3.jpg" class="w-100" alt>
                                                            </div>
                                                            <div class="search-result-desc pl-10">
                                                                <a href="single-product-4.html" class="title px-0">LANDSCAPE
                                                                    -
                                                                    Folding
                                                                    fabric
                                                                    deck
                                    ...
                                    <div class="minicart">
                                                ...
                                                <ul class="text-left">
                                                    <li>
                                                        <div class="minicart-img">
                                                            <a href="single-product-4.html" class="p-0"><img src="../FrontAssets/img//product/1.jpg" class="w-100" alt></a>
                                                        </div>
                                                        <div class="minicart-desc">
                                                            <a href="single-product-4.html" class="p-0">Capitalize
                                                                on low
                                                                hanging
                                                                fruit t</a>
                                                            <strong>1 ×
                                                    ...
                                                    <li>
                                                        <div class="minicart-img">
                                                            <a href="single-product-4.html" class="p-0"><img src="../FrontAssets/img//product/2.jpg" class="w-100" alt></a>
                                                        </div>
                                                        <div class="minicart-desc">
                                                            <a href="single-product-4.html" class="p-0">Leather
                                                                Courriere
                                                                duffle ba</a>
                                                            <strong>1 ×
                                                                $150.00</strong>
                                                    ...
                                                    <li>
                                                        <div class="minicart-img">
                                                            <a href="single-product-4.html" class="p-0"><img src="../FrontAssets/img//product/3.jpg" class="w-100" alt></a>
                                                        </div>
                                                        <div class="minicart-desc">
                                                            <a href="single-product-4.html" class="p-0">Party
                                                                Supplies
                                                                Around
                                                                Cupcake</a>
                                                            <strong>1 ×
                                        ...
                                        <div class="minicart-checkout">
                                            ...
                                            <div class="minicart-checkout-links">
                                                <a href="cart.html" class="generic-btn black-hover-btn text-uppercase w-100 mb-20">View
                                                    cart</a>
    ...
    <div class="has-breadcrumb-bg mb-120" data-background="../FrontAssets/img//bg/3.jpg">
                    ...
                    <div class="col-xl-3 hidden-xl">
                        ...
                        <div class="widget">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="list">
                                    <a href="javascript:void(0)">Char &
                                        Table <span>(10)</span></a>
                                    ...
                                    <div id="collapse-2" class="collapse">
                                        <div class="sidebar-list">
                                            <ul>
                                                <li><a href="shop.html">Chair
                                                        <span>(30)</span></a></li>
                                                <li><a href="shop4.html">Clothing
                                                        <span>(45)</span></a></li>
                                                <li><a href="shop4.html">Decore
                                                        <span>(20)</span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="list">
                                    <a href="javascript:void(0)">Handbag
                                        <span>(10)</span></a>
                                    ...
                                    <div id="collapse-3" class="collapse">
                                        <div class="sidebar-list">
                                            <ul>
                                                <li><a href="shop4.html">Camerass
                                                        <span>(1)</span></a></li>
                                                <li><a href="shop4.html">Gift
                                                        Cards <span>(5)</span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="list">
                                    ...
                                    <div id="collapse-4" class="collapse">
                                        <div class="sidebar-list">
                                            <ul>
                                                <li><a href="shop3.html">Lightings
                                                        <span>(1)</span></a></li>
                                                <li><a href="shop3.html">Managed
                                                        <span>(5)</span></a></li>
                                                <li><a href="shop3.html">Printers
                                                        <span>(32)</span></a></li>
                                                <li><a href="shop3.html">Shoes
                                                        <span>(32)</span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <form action="#">
                                <div class="price-filter">
                                    ...
                                    <div class="filter-form-submit mt-35">
                                        ...
                                        <div class="filter-price d-inline-block pl-20">Price:
                                            <input type="button" id="amount" value="$75 - $300">
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="widget mt-50">
                            ...
                            <div class="post-box">
                                <ul>
                                    <li>
                                        <div class="post-img">
                                            <img src="../FrontAssets/img//product/1.jpg" class="w-100" alt>
                                        </div>
                                        <div class="post-img-desc">
                                            <a href="single-product-4.html">Capitalize
                                                on low hanging fruit to</a>
                                            <div class="price">$250.00</div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="post-img">
                                            <img src="../FrontAssets/img//product/2.jpg" class="w-100" alt>
                                        </div>
                                        <div class="post-img-desc">
                                    ...
                                    <li>
                                        <div class="post-img">
                                            <img src="../FrontAssets/img//product/3.jpg" class="w-100" alt>
                                        </div>
                                        <div class="post-img-desc">
                                            <a href="single-product-4.html">
                                                Tassels pendant earringso</a>
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                    <div class="filter-shown-item">
                                        <p class="mb-0">Showing <span>1</span>–<span>24</span>
                                            of <span class="total_count">56</span>
                                            results</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                    <div class="shop-filter-tab">
                                        <ul class="nav nav-pills" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="active" data-toggle="pill" href="#shop-tab-1" data-toggle="tooltip" data-placement="top" title="2 grid"><i class="fal fa-line-columns"></i></a>
                                            </li>
                                            <li class="nav-item">
                                                            ...
                                                            <div class="price-filter">
                                                                ...
                                                                <div class="filter-form-submit mt-35">
                                                                    ...
                                                                    <div class="filter-price d-inline-block pl-20">
                                                                        Price:
                                                                        <input type="button" id="amount-2" value="$75 - $300">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
                                ...
                                <div class="tab-pane fade show active" id="shop-tab-1">
                                    <div class="product-wrapper mt-55">
                                        <div class="row">
                                                ...
                                                <div class="product-box mb-40">
                                                    <div class="product-box-wrapper">
                                                        <div class="product-img">
                                                            <img src="../FrontAssets/img//product/5.jpg" class="w-100" alt>
                                                            <a href="single-product-4.html" class="d-block">
                                                                <div class="second-img">
                                                                    <img src="../FrontAssets/img//product/5-hover.jpg" alt class="w-100">
                                                                </div>
                                                            </a>
                                                        ...
                                                        <div class="product-desc pb-20">
                                                            ...
                                                            <a href="single-product-4.html" class="product-title">Light
                                                                green
                                                                crewnec...</a>
                                            ...
                                            <div class="col-6">
                                                <div class="product-box mb-40">
                                                    <div class="product-box-wrapper">
                                                        <div class="product-img">
                                                            <img src="../FrontAssets/img//product/4.jpg" class="w-100" alt>
                                                            <a href="single-product-4.html" class="d-block">
                                                                <div class="second-img">
                                                                    <img src="../FrontAssets/img//product/4-hover.jpg" alt class="w-100">
                                                                </div>
                                                            </a>
                                                            <a href="javascript:void(0)" class="product-img-link quick-view-1 text-capitalize">Quick
                                                                view</a>
                                                        ...
                                                        <div class="product-desc pb-20">
                                                            ...
                                                            <a href="single-product-4.html" class="product-title">Tassels
                                                                Pendant
                                                                Earrings</a>
                                                            <div class="price-switcher">
                                            ...
                                            <div class="col-6">
                                                <div class="product-box mb-40">
                                                    <div class="product-box-wrapper">
                                                        <div class="product-img">
                                                            <img src="../FrontAssets/img//product/7.jpg" class="w-100" alt>
                                                            <a href="single-product-4.html" class="d-block">
                                                                <div class="second-img">
                                                                    <img src="../FrontAssets/img//product/7-hover.jpg" alt class="w-100">
                                                                </div>
                                                            </a>
                                                            <a href="javascript:void(0)" class="product-img-link quick-view-1 text-capitalize">Quick
                                                                view</a>
                                                        ...
                                                        <div class="product-desc pb-20">
                                                            ...
                                                            <a href="single-product-4.html" class="product-title">Leather
                                                                Courriere
                                                                duffle
                                                                bag</a>
                                                            <div class="price-switcher">
                                            ...
                                            <div class="col-6">
                                                <div class="product-box mb-40">
                                                    <div class="product-box-wrapper">
                                                        <div class="product-img">
                                                            <img src="../FrontAssets/img//product/8.jpg" class="w-100" alt>
                                                            <a href="single-product-4.html" class="d-block">
                                                                <div class="second-img">
                                                                    <img src="../FrontAssets/img//product/8-hover.jpg" alt class="w-100">
                                                                </div>
                                                            </a>
                                                            <a href="javascript:void(0)" class="product-img-link quick-view-1 text-capitalize">Quick
                                                                view</a>
                                            ...
                                            <div class="col-6">
                                                <div class="product-box mb-40">
                                                    <div class="product-box-wrapper">
                                                        <div class="product-img">
                                                            <img src="../FrontAssets/img//product/9.jpg" class="w-100" alt>
                                                            <a href="single-product-4.html" class="d-block">
                                                                <div class="second-img">
                                                                    <img src="../FrontAssets/img//product/9-hover.jpg" alt class="w-100">
                                                                </div>
                                                            </a>
                                                            <a href="javascript:void(0)" class="product-img-link quick-view-1 text-capitalize">Quick
                                                                view</a>
                                        ...
                                        <div class="text-center mt-20">
                                            <a href="shop.html" class="load-more">LOAD
                                                MORE...</a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-md-4 col-6">
                                                <div class="product-box mb-40">
                                                    <div class="product-box-wrapper">
                                                        <div class="product-img">
                                                            <img src="../FrontAssets/img//product/6.jpg" class="w-100" alt>
                                                            <a href="single-product-4.html" class="d-block">
                                                                <div class="second-img">
                                                                    <img src="../FrontAssets/img//product/6-hover.jpg" alt class="w-100">
                                                                </div>
                                                            </a>
                                                            <a href="javascript:void(0)" class="product-img-link quick-view-1 text-capitalize">Quick
                                                                view</a>
                                                        ...
                                                        <div class="product-desc pb-20">
                                                            <div class="product-desc-top">
                                                                <div class="categories">
                                                                    <a href="shop2.html" class="product-category"><span>Handbag</span></a>
                                                                    <a href="shop2.html" class="product-category"><span>Handbag</span></a>
                                                                </div>
                                                                <a href="wishlist.html" class="wishlist float-right"><span><i class="fal fa-heart"></i></span></a>
                                                            </div>
                                                            <a href="single-product-4.html" class="product-title">Coating
                                                                design
                                                                lighting
                                                                lamp</a>
                                                            <div class="price-switcher">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-8 col-lg-8 col-md-8">
                                                                <div class="list-product-desc">
                                                                    <h3><a href="single-product-5.html" class="title mb-15">Blandit
                                                                            vel
                                                                            eros
                                                                            condimentum
                                                                            ulla</a></h3>
                                                                    ...
                                                                    <div class="desc">
                                                                        ...
                                                                        <a href="cart.html" class="list-add-cart-btn text-capitalize mt-40">+add
                                                                            to
                                                                            cart</a>
                                                                        <a href="single-product-5.html" data-toggle="tooltip" data-placement="top" title="wishlist"><span><i class="fal fa-heart"></i></span></a>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-8 col-lg-8 col-md-8">
                                                                <div class="list-product-desc">
                                                                    ...
                                                                    <div class="price"><span class="red-color">$399</span><del>$499</del>
                                                                    </div>
                                                                    <div class="desc">
                                                                        <p>Typi
                                                                            non
                                                    ...
                                                    <div class="list-product-wrapper">
                                                        <div class="row">
                                                            <div class="col-xl-4 col-lg-4 col-md-4">
                                                                <div class="list-product-img">
                                                                    <div class="product-img">
                                                                        <img src="../FrontAssets/img//product/farniture-1.jpg" class="w-100" alt>
                                                                        <a href="single-product-4.html" class="d-block">
                                                                            <div class="second-img">
                                                                                <img src="../FrontAssets/img//product/farniture-1-hover.jpg" alt class="w-100">
                                                                            </div>
                                                                        </a>
                                                                        <a href="javascript:void(0)" class="product-img-link quick-view-1 text-capitalize">Quick
                                                                            view</a>
                                                                ...
                                                                <div class="list-product-desc">
                                                                    ...
                                                                    <div class="desc">
                                                                        ...
                                                                        <a href="cart.html" class="list-add-cart-btn text-capitalize mt-40">+add
                                                                            to
                                                                            cart</a>
                                                                        <a href="wishlist.html" data-toggle="tooltip" data-placement="top" title="wishlist"><span><i class="fal fa-heart"></i></span></a>
                                                                        <a href="javascript:void(0)" data-toggle="tooltip" data-placement="top" title="compare"><span><i class="fal fa-abacus"></i></span></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="list-product-wrapper">
                                                        <div class="row">
                                                            <div class="col-xl-4 col-lg-4 col-md-4">
                                                                <div class="list-product-img">
                                                                    <div class="product-img">
                                                                        <img src="../FrontAssets/img//product/farniture-2.jpg" class="w-100" alt>
                                                                        <a href="single-product-4.html" class="d-block">
                                                                            <div class="second-img">
                                                                                <img src="../FrontAssets/img//product/farniture-2-hover.jpg" alt class="w-100">
                                                                            </div>
                                                                        </a>
                                                                        <a href="javascript:void(0)" class="product-img-link quick-view-1 text-capitalize">Quick
                                                                            view</a>
                        ...
                        <div class="col-xl-4 col-md-6 service-item">
                            <div class="service-box service-box-2">
                                <div class="service-box-content">
                                    ...
                                    <p class="service-desc">Duis autem vel
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-9">
                                <div class="footer-item has-desc">
                                    <div class="footer-logo mb-25">
                                        <img src="../FrontAssets/img//logo/logo2.png" width="120" height="31" alt>
                                    </div>
                                    <div class="footer-desc">
                                        <p class="mb-10">Mazia store is a
                                            premium theme with advanced
                                            admin module. It’s
                                            extremely customizable, easy to
                                            use and fully responsive and
                                            retina ready.
                                        </p>
                                    </div>
                                    <div class="footer-img mt-65">
                                        <img src="../FrontAssets/img//logo/paypal.png" alt>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="product-popup-1">
                                    <div class="product-popup-img">
                                        <img src="../FrontAssets/img//product/10.jpg" class="w-100" alt>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="product-popup-2">
                                    <div class="product-popup-img">
                                        <img src="../FrontAssets/img//product/11.jpg" class="w-100" alt>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="product-popup-3">
                                    <div class="product-popup-img">
                                        <img src="../FrontAssets/img//product/12.jpg" class="w-100" alt>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- JS here -->
    <script src="../FrontAssets/js/vendor/jquery-1.12.4.min.js"></script>
    ...
    <script src="../FrontAssets/js/isotope.pkgd.min.js"></script>
    <script src="../FrontAssets/js/one-page-nav-min.js"></script>
    <script src="../FrontAssets/js/slick.min.js"></script>
    <script src="../FrontAssets/js/jquery.meanmenu.min.js"></script>
    <script src="../FrontAssets/js/ajax-form.js"></script>
    <script src="../FrontAssets/js/fontawesome.min.js"></script>
    <script src="../FrontAssets/js/wow.min.js"></script>
    <script src="../FrontAssets/js/jquery-ui.js"></script>
    <script src="../FrontAssets/js/jquery.scrollUp.min.js"></script>
    <script src="../FrontAssets/js/imagesloaded.pkgd.min.js"></script>
