<?php
    ...
    if(isset($_POST["action"])){
        ...
        $sql_query = "SELECT * FROM products p INNER JOIN brands b ON p.brand = b.br_id INNER JOIN types t ON p.type = t.ty_id WHERE p.parent_item_id = p.pr_id AND b.isSales = 'YES' AND p.isOnlineSales = 1 AND p.p_created != ''";
