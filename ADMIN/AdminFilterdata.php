...
require "../MAIN/Dbconn.php"; 
    ...
    if(isset($_POST["action"])){
        ...
        $sql_query = "SELECT * FROM products p INNER JOIN brands b ON p.brand = b.br_id INNER JOIN types t ON p.type = t.ty_id WHERE p.parent_item_id = p.pr_id AND p.p_created != ''";
...
?>
            <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3 my-2 ">    
                <div class="card card-body shadow-sm ">
                    <a href="AdminProductdetail.php?product_id=<?php echo $item['pr_id'];?>">
