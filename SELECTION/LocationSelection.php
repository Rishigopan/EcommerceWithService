    ...
    <div class="wrapper">
        ...
        <nav class="navbar shadow-sm fixed-top py-0" style="background-color:#F50414;">
            <div class="container-fluid ">
                ...
                <div>
                    <a class="btn shadow-none" href="./ServiceSelection.php"><i class="material-icons">west</i></a>
                        ...
                        <div class="card card-body shadow-sm mb-5" id="main_card">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-9 col-lg-9">
                                    <div>
                                        <h5 class="border-bottom pb-2">Choose Location</h5>
                                    </div>
                                    <div id="main_list">
                                        <ul class="brand_list list-unstyled  my-3">
                                            <li class="mx-1 mb-3">
                                                <a href="ServiceSession.php?location=Shop">
                                                    <div class="card card-body brands py-2 mb-2">
                                                        <div class="d-flex">
                                                            <img src="../shop (2).png" alt="Brand">
                                                            <div class="ps-3 pt-2">
                                                                <h6 class="">Visit Service Centre</h6>
                                                                <p class="text-muted">1st Floor,MDDA complex,clock tower,Kerala</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <li class="mx-1 ">
                                                <a href="ServiceSession.php?location=Doorstep">
                                                    <div class="card card-body brands py-2 mb-2">
                                                        <div class="d-flex">
                                                            <img src="../delivery (2).png" alt="Brand">
                                                            <div class="ps-3 pt-2">
                                                                <h6 class="">Doorstep Service</h6>
                                                                <p class="text-muted">Our technician will visit or pickup your device from your location</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                ...
                                <div id="Page_nav " class="d-flex justify-content-between pt-3 px-4 ">
                                    <a class="btn shadow-none rounded-pill  back px-md-4 " href="ServiceSelection.php">
                                        <i class="d-md-none material-icons">arrow_back_ios</i>
                                        <span class="d-none d-md-inline-block">BACK</span>
                                    </a>
                                    <button class="btn shadow-none rounded-pill next px-md-4 ">
