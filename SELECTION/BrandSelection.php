                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-9 col-lg-9">
                                    ...
                                    <div class=" row  mx-md-0 pt-3" id="brand_list">
                                        ...
                                        $brand_query = mysqli_query($con, "SELECT B.br_id,B.brand_name,B.brand_img FROM products P INNER JOIN types T ON P.type = T.ty_id INNER JOIN brands B ON P.forBrand = B.br_id INNER JOIN series S ON P.forSeries = S.se_id INNER JOIN products Pdisplay ON P.forProduct = Pdisplay.pr_id LEFT JOIN color C ON P.color = C.colorId WHERE T.ty_id = $SelectionId GROUP BY B.br_id ORDER BY B.brand_name ASC");
                                        if (mysqli_num_rows($brand_query) > 0) {
                                            foreach ($brand_query as $brands) {
                                        ?>
                                                <div class="col-6 col-md-4 col-xl-3">
                                                    <a href="ServiceSession.php?Brand=<?= $brands['br_id']; ?>&SelectionId=<?= $SelectionId ?>">
