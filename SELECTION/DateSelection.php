                                                    ...
                                                    <div id="Time_select" class="card  mb-3">
                                                        ...
                                                        <div class="card-body">
                                                            <div id="Time_row" class="row">
                                                                <div class="col-4">
                                                                    <input type="radio" id="time_1" name="time_radio" value="10AM - 11AM" required>
                                                                    <label for="time_1" class="w-100 text-center px-0 time_label">
                                                                        <h6 class="my-auto">10AM - 11AM</h6>
                                                                    </label>
                                                                </div>
                                                                <div class="col-4">
                                                                    <input type="radio" id="time_2" name="time_radio" value="11AM - 12PM">
                                                                    <label for="time_2" class="w-100 text-center px-0 time_label">
                                                                        <h6 class="my-auto">11AM - 12PM</h6>
                                                                    </label>
                                                                </div>
                                                                <div class="col-4">
                                                                    <input type="radio" id="time_3" name="time_radio" value="12PM - 1PM">
                                                                    <label for="time_3" class="w-100 text-center px-0 time_label">
                                                                        <h6 class="my-auto">12PM - 1PM</h6>
                                                                    </label>
                                                                </div>
                                                                <div class="col-4">
                                                                    <input type="radio" id="time_4" name="time_radio" value="1PM - 2PM">
                                                                    <label for="time_4" class="w-100 text-center px-0 time_label">
                                                                        <h6 class="my-auto">1PM - 2PM</h6>
                                                                    </label>
                                                                </div>
                                                                <div class="col-4">
                                                                    <input type="radio" id="time_5" name="time_radio" value="2PM - 3PM">
                                                                    <label for="time_5" class="w-100 text-center px-0 time_label">
                                                                        <h6 class="my-auto">2PM - 3PM</h6>
                                                                    </label>
                                                                </div>
                                                                <div class="col-4">
                                                                    <input type="radio" id="time_6" name="time_radio" value="3PM - 4PM">
                                                                    <label for="time_6" class="w-100 text-center px-0 time_label">
                                                                        <h6 class="my-auto">3PM - 4PM</h6>
                                                                    </label>
                                                                </div>
                                                                <div class="col-4">
                                                                    <input type="radio" id="time_7" name="time_radio" value="4PM - 5PM">
                                                                    <label for="time_7" class="w-100 text-center px-0 time_label">
                                                                        <h6 class="my-auto">4PM - 5PM</h6>
                                                                    </label>
                                                                </div>
                                                                <div class="col-4">
                                                                    <input type="radio" id="time_8" name="time_radio" value="5PM - 6PM">
                                                                    <label for="time_8" class="w-100 text-center px-0 time_label">
                                                                        <h6 class="my-auto">5PM - 6PM</h6>
                                                                    </label>
                                                                </div>
                                                                <div class="col-4">
                                                                    <input type="radio" id="time_9" name="time_radio" value="6PM - 7PM">
                                                                    <label for="time_9" class="w-100 text-center px-0 time_label">
                                                                        <h6 class="my-auto">6PM - 7PM</h6>
                                                                    </label>
                                                                </div>
                                                                <div class="col-4">
                                                                    <input type="radio" id="time_10" name="time_radio" value="7PM - 8PM">
                                                                    <label for="time_10" class="w-100 text-center px-0 time_label">
                                                                        <h6 class="my-auto">7PM - 8PM</h6>
                                                                    </label>
                                                                </div>
                                                                <div class="col-4">
                                                                    <input type="radio" id="time_11" name="time_radio" value="8PM - 9PM">
                                                                    <label for="time_11" class="w-100 text-center px-0 time_label">
                                                                        <h6 class="my-auto">8PM - 9PM</h6>
                                                                    </label>
                                                                </div>
                                                                <div class="col-4">
                                                                    <input type="radio" id="time_12" name="time_radio" value="9PM - 10PM">
                                                                    <label for="time_12" class="w-100 text-center px-0 time_label">
                                                                        <h6 class="my-auto">9PM - 10PM</h6>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
