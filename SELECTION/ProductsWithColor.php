    ...
    <div class="wrapper">
        ...
        <nav class="navbar shadow-sm fixed-top p-0" style="background-color:#f50414;">
            <div class="container-fluid">
                <div>
                    <a class="btn shadow-none" href="./ColorSelection.php"><i class="material-icons">west</i></a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-9 col-lg-9">
                                    ...
                                    <div class=" row  mx-md-0 pt-3" id="brand_list">
                                        ...
                                        $ProductWithColorQuery = "SELECT P.name,P.img,P.pr_id,P.current_stock FROM products P INNER JOIN types T ON P.type = T.ty_id INNER JOIN brands B ON P.forBrand = B.br_id INNER JOIN series S ON P.forSeries = S.se_id INNER JOIN products Pdisplay ON P.forProduct = Pdisplay.pr_id INNER JOIN producttype PT ON P.productType = PT.productTypeId WHERE T.ty_id = $SelectionId AND B.br_id = $Brand AND P.forProduct = $Model AND P.producttype = $ProductType AND P.color = $ProductColor";

                                        $ProductQuery = mysqli_query($con, $ProductWithColorQuery);
