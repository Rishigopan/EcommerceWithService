    ...
    <div class="wrapper">
        ...
        <nav class="navbar shadow-sm fixed-top">
            <div class="container-fluid ">
                ...
                <!-- <a class="navbar-text d-md-flex d-none me-auto">
                    <h5>CONNECT MY MOBILE</h5>
                </a> -->
                <form class="  d-none d-sm-block ">
                    <input id="searchbox" class="form-control  rounded-pill shadow-none border-0" type="text" placeholder="Start Typing..." aria-label="Search">
                </form>
                <div class=" ">
            ...
            <div class="offcanvas-body">
                <div class="container-fluid filter_all">
                    ...
                    <div class="mt-3 mb-4">
                        <h6>Brands</h6>
                        <?php
                        $brand_check_query = mysqli_query($con, "SELECT * FROM brands WHERE isSales = 'YES'");
                    ...
                    <div class="mt-3">
                        <div class=" form-check-inline me-3 mb-2">
                            ...
                            <label class="btn shadow-none rounded-pill px-4" for="btnradio1">A - Z</label>
                        </div>
                        <div class="me-3 form-check-inline mb-2">
                            ...
                            <label class="btn shadow-none rounded-pill px-4" for="btnradio2">Z - A</label>
                        </div>
                        <div class="me-3 form-check-inline mb-2">
                            <input type="radio" class="btn-check comm_select L2H" name="btnradio" value="" id="btnradio3">
                            <label class="btn shadow-none rounded-pill px-3" for="btnradio3">Price:Low to High</label>
                        </div>
                        <div class="me-3 form-check-inline mb-2">
                            <input type="radio" class="btn-check comm_select H2L " name="btnradio" id="btnradio4">
                            <label class="btn shadow-none rounded-pill px-3" for="btnradio4">Price: High to Low</label>
                        </div>
                    </div>
                        ...
                        <div class="accordion accordion-flush shadow" id="accordionFlushExample">
                            ...
                            <div class="accordion-item ">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        <?php
                                        $brand_check_query = mysqli_query($con, "SELECT * FROM brands WHERE isSales = 'YES' ORDER BY brand_name ASC");
                                        foreach ($brand_check_query as $brand_checks) {
                                        ?>
                                            <div class="form-check">
