                        ...
                        <div class="card card-body shadow-sm mb-5" id="main_card">
                            <div class="row">
                                <div class="col-12 col-md-3 col-lg-3">
                                    <div id="sidenav" class="d-flex d-md-block mb-md-0">
                                        ...
                                        <div class="d-flex ps-3 ps-md-0">
                                            ...
                                            <p class="ps-2 d-none d-md-block"><span class="d-none d-xl-inline">Choose</span><span>Color</span></p>
                                        </div>
                                        <div class="d-flex ps-3 ps-md-0">
                                ...
                                <div class="col-12 col-md-9 col-lg-9">
                                    <div>
                                        <h5 class="border-bottom pb-2">Choose Color</h5>
                                    </div>
                                    <div class=" row  mx-md-0 pt-3" id="brand_list">
                                        ...
                                        $ProductTypeQuery = mysqli_query($con, "SELECT C.colorName,C.colorId,C.colorImage FROM products P INNER JOIN types T ON P.type = T.ty_id INNER JOIN brands B ON P.forBrand = B.br_id INNER JOIN series S ON P.forSeries = S.se_id INNER JOIN products Pdisplay ON P.forProduct = Pdisplay.pr_id INNER JOIN producttype PT ON P.productType = PT.productTypeId INNER JOIN color C ON P.color = C.colorId WHERE T.ty_id = '$SelectionId' AND P.forBrand = '$Brand' AND Pdisplay.pr_id = $Model AND PT.productTypeId = $ProductType GROUP BY C.colorId ORDER BY C.colorName ASC");
                                        if (mysqli_num_rows($ProductTypeQuery) > 0) {
                                            foreach ($ProductTypeQuery as $ProductTypeQueryResults) {
                                        ?>
                                                <div class="col-6 col-md-4 col-xl-3">
                                                    <a href="ServiceSession.php?ProductColor=<?= $ProductTypeQueryResults['colorId'] ?>">
                                                        <div class="card card-body brands mb-3 ">
                                                            <div class="d-block text-center ">
                                                                <img src="../assets/img/COLOR/<?php echo $ProductTypeQueryResults['colorImage']; ?>" alt="ProductType">
                                                                <h6 class=" "><?php echo $ProductTypeQueryResults['colorName']; ?></h6>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
